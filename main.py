...
class Game:
    def __init__(self):
        ...
        self.button_images = [pygame.transform.scale(pygame.image.load('Images/LOST.png'), default_button_size),
                              pygame.transform.scale(pygame.image.load('Images/WIN.png'), default_button_size),
                              pygame.transform.scale(pygame.image.load('Images/TIE.png'), default_button_size)]
    ...
    def draw_side(self):
        screen.blit(pygame.font.Font.render(self.font, "Rock = " + str(self.numRock), False, self.textColor, None), (screen.get_width() - 100, screen.get_height()/2 - 100))
        screen.blit(pygame.font.Font.render(self.font, "Scissors = " + str(self.numSci), False, self.textColor, None), (screen.get_width() - 100, screen.get_height()/2))
        screen.blit(pygame.font.Font.render(self.font, "Paper = " + str(self.numPap), False, self.textColor, None), (screen.get_width() - 100, screen.get_height()/2 + 100))
